...
function MenubarCheckboxItem({
  ...
  return (
    <MenubarPrimitive.CheckboxItem
      ...
      data-inset={inset}
      className={cn(
        "relative flex cursor-default items-center gap-1.5 rounded-md py-1 pr-1.5 pl-7 text-[12px] outline-hidden transition-colors duration-75 select-none focus:bg-accent focus:text-accent-foreground focus:[&_svg]:text-accent-foreground data-inset:pl-7 data-disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      checked={checked}
      {...props}
...
function MenubarLabel({
  ...
  return (
    <MenubarPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-1.5 py-1 text-[11px] font-semibold tracking-wide text-muted-foreground uppercase data-inset:pl-7",
        className
      )}
      {...props}
    />
...
function MenubarSeparator({
  ...
  return (
    <MenubarPrimitive.Separator
      ...
      className={cn("-mx-1 my-1 h-px bg-black/12", className)}
      {...props}
    />
  )
}
...
function MenubarShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-[11px] tracking-wide text-muted-foreground tabular-nums group-focus/menubar-item:text-accent-foreground",
        className
      )}
      {...props}
    />
...
function MenubarSubTrigger({
  ...
  return (
    <MenubarPrimitive.SubTrigger
      ...
      data-inset={inset}
      className={cn(
        "flex cursor-default items-center gap-1.5 rounded-md px-1.5 py-1 text-[12px] outline-none transition-colors duration-75 select-none focus:bg-accent focus:text-accent-foreground data-inset:pl-7 data-open:bg-accent data-open:text-accent-foreground [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props}
    >
